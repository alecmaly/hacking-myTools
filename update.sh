...
# download fuzz.txt
wget -q "https://raw.githubusercontent.com/Bo0oM/fuzz.txt/master/fuzz.txt" -O /usr/share/wordlists/fuzz.txt
wlk /usr/share/wordlists/fasttrack_backup.txt /usr/share/wordlists/fuzz.txt /opt/SecLists/Passwords/Common-Credentials/best1050.txt /opt/SecLists/Passwords/darkweb2017-top10000.txt > /opt/hacking-myTools/wordlists/top1000_1050_fasttrack.txt
