...
parser.add_argument('--input', '-i', required=False,default=(None if sys.stdin.isatty() else sys.stdin.readline().decode('utf-8')), help='shellcode, assembly instructions, or filepath')
