...
wlk /opt/hacking-myTools/wordlists/custom-base/directory-brute.txt /opt/SecLists/Discovery/Web-Content/raft-large-words-lowercase.txt /opt/SecLists/Discovery/Web-Content/common.txt /opt/SecLists/Discovery/Web-Content/directory-list-lowercase-2.3-medium.txt > largeRaftPlus2.3Medium-lowercase.txt
